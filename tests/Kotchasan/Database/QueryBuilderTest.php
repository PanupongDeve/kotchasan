...
/**
 * Generated by PHPUnit_SkeletonGenerator on 2018-10-15 at 20:06:30.
 */
class QueryBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAndWhere2()
    {
        ...
        $this->assertEquals(
          " WHERE (U.`id` = 1) AND (`id` BETWEEN 0 AND 1 OR `id` BETWEEN 0 AND 1)", $this->object->where(array('U.id', 1))->andWhere(array(Sql::BETWEEN('id', 0, 1), Sql::BETWEEN('id', 0, 1)), 'OR')->text()
        );
    }
    ...
    public function testInsert()
    {
        ...
        $this->assertEquals(
          "INSERT INTO `user` (`id`, `name`) VALUES (1, 'test')", $this->object->insert('user', array('id' => 1, 'name' => 'test'))->text()
        );
    }
    ...
    public function testInsertOrUpdate()
    {
        ...
        $this->assertEquals(
          "INSERT INTO `user` (`id`, `name`) VALUES (1, 'test') ON DUPLICATE KEY UPDATE `id`=VALUES(`id`), `name`=VALUES(`name`)", $this->object->insertOrUpdate('user', array('id' => 1, 'name' => 'test'))->text()
        );
    }
    ...
    public function testOrWhere2()
    {
        ...
        $this->assertEquals(
          " WHERE (U.`id` = 1) OR (`id` BETWEEN 0 AND 1 OR `id` BETWEEN 0 AND 1)", $this->object->where(array('U.id', 1))->orWhere(array(Sql::BETWEEN('id', 0, 1), Sql::BETWEEN('id', 0, 1)), 'OR')->text()
        );
    }
    ...
    public function testSelect10()
    {
        ...
        $this->assertEquals(
          "SELECT U.`field`,U1.`field`,NULL AS `id`", $this->object->select('U.field', 'U1.`field`', 'NULL id')->text()
        );
    }
    ...
    public function testSet7()
    {
        ...
        $this->assertEquals(
          "UPDATE `user` SET `create_date`=NOW()", $this->object->update('user')->set(array('create_date' => Sql::NOW()))->text()
        );
    }
    ...
    public function testSet8()
    {
        ...
        $this->assertEquals(
          "UPDATE `user` SET `create_date`=SELECT * FROM `a`", $this->object->update('user')->set(array('create_date' => Sql::create('SELECT * FROM `a`')))->text()
        );
    }
    ...
    public function testUnion()
    {
        ...
        $this->assertEquals(
          "(SELECT * FROM `a`) UNION (SELECT * FROM `b`)", $this->object->union(Sql::create('SELECT * FROM `a`'), Sql::create('SELECT * FROM `b`'))->text()
        );
    }
    ...
    public function testUnion2()
    {
        ...
        $this->assertEquals(
          "(SELECT * FROM `a`) UNION (SELECT * FROM `b`)", $this->object->union(array(Sql::create('SELECT * FROM `a`'), Sql::create('SELECT * FROM `b`')))->text()
        );
    }
    ...
    public function testUnionAll()
    {
        ...
        $this->assertEquals(
          "(SELECT * FROM `a`) UNION ALL (SELECT * FROM `b`)", $this->object->unionAll(Sql::create('SELECT * FROM `a`'), Sql::create('SELECT * FROM `b`'))->text()
        );
    }
    ...
    public function testUnionAll2()
    {
        ...
        $this->assertEquals(
          "(SELECT * FROM `a`) UNION ALL (SELECT * FROM `b`)", $this->object->unionAll(array(Sql::create('SELECT * FROM `a`'), Sql::create('SELECT * FROM `b`')))->text()
        );
    }
    ...
    public function testWhere4()
    {
        ...
        $this->assertEquals(
          " WHERE `domain` = 'domain.tld'", $this->object->where(array('domain', 'domain.tld'))->text()
        );
    }
    ...
    public function testWhere12()
    {
        ...
        $this->assertEquals(
          " WHERE `social` = '0' AND (...)", $this->object->where(array(array('social', '0'), Sql::create('(...)')))->text()
        );
    }
    ...
    public function testWhere19()
    {
        ...
        $this->assertEquals(
          " WHERE U.`id` = 'G.id'", $this->object->where(array('U.id', Sql::strValue('G.id')))->text()
        );
    }
    ...
    public function testWhere20()
    {
        ...
        $this->assertEquals(
          " WHERE U.`id` IS NULL", $this->object->where(Sql::ISNULL('U.id'))->text()
        );
    }
    ...
    public function testWhere21()
    {
        ...
        $this->assertEquals(
          " WHERE `create_date` = 'A' AND `id` BETWEEN 'ทดสอบ' AND 'ทดสอบ'", $this->object->where(array(array('create_date', 'A'), Sql::BETWEEN('id', 'ทดสอบ', 'ทดสอบ')))->text()
        );
    }
    ...
    public function testWhere22()
    {
        ...
        $this->assertEquals(
          " WHERE `id` BETWEEN 0 AND 1 OR `id` BETWEEN 0 AND 1 OR `id` BETWEEN 0 AND 1 OR `id` BETWEEN 0 AND 1", $this->object->where(array(array(Sql::BETWEEN('id', 0, 1), 'OR', Sql::BETWEEN('id', 0, 1)), array(Sql::BETWEEN('id', 0, 1), 'OR', Sql::BETWEEN('id', 0, 1))), 'OR')->text()
        );
    }
}